...
//         if(lambda <= 0)
//         {
//             printf("Lambda is negative or zero! PANIC!");
...
//     simulation_result* sim_results = simulator_tools::allocate_results(strategy, variable_count, &allocator, false);
//
...
//     simulator_tools::read_results(sim_results, total_simulations, &node_results, &lend_variable_r, false);
//     simulator_tools::print_results(&node_results, &lend_variable_r, total_simulations);
//
...
//     array_t<variable_result> variable_r = simulator_tools::allocate_variable_results(variable_count);
//     const lend_array<variable_result> lend_variable_r = lend_array<variable_result>(&variable_r);
//     simulation_result* sim_results = simulator_tools::allocate_results(strategy, variable_count, &allocator, true);
//
...
//             simulator_tools::read_results(local_results, total_simulations, &node_results, &lend_variable_r, true);
//             free(local_results);
//         }
//     }
//
...
//     {
//         simulator_tools::print_results(&node_results, &lend_variable_r, total_simulations * strategy->sim_count);
//     }
//     else
//     {
